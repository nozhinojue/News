...
import com.example.cjj.news.common.AppRunCache;
import com.example.cjj.news.service.IntentFilterUtils;
import com.example.cjj.news.service.MyMusicService;
import com.example.cjj.news.util.FastBlur;
import com.example.cjj.news.util.TimeUtils;
...
public class MusicFragment extends BaseFragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
   private RelativeLayout rlBg;
    ...
    private void getData(){
        new AppActionImpl().getMusicData(musicType, new ActionCallbackListener<MusicMainData>() {
            @Override
            public void onSuccessed(MusicMainData musicMainData) {
